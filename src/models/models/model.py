...
class prithvi_wrapper(nn.Module):
    def __init__(self,n_channels, n_classes, n_frame, embed_size, depth, input_size, patch_size, prithvi_weight, fpn1_type, freeze_backbone=False):
        ...
        self.neck=Neck(self.neck_embedding, self.patch_size, self.fpn1_type)
