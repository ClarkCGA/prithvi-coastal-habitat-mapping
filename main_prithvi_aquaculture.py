...
def main():
    ...
    print(f"FPN1 choice in neck:{fpn1_type}")
    ...
    #model=model_wrapper(n_channel, n_class, n_frame, embed_size, depth, input_size, patch_size, model_weights, fpn1_type, freeze_backbone)
    model=model_wrapper(n_channel, n_class, n_frame, embed_size, depth, input_size, patch_size, prithvi_weight=None, fpn1_type=fpn1_type, freeze_backbone=freeze_backbone) 
